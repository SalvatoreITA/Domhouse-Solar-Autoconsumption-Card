console.info("%c ☀️ DOMHOUSE-SOLAR-AUTOCONSUMPTION-CARD v3.1.1 (HA 2026.5 FIX) IS LOADED ", "color: white; background: #FF9800; font-weight: bold;");
...
// =============================================================================
//  VISUAL EDITOR CLASS (Aggiornato per HA >= 2026.5)
// =============================================================================
class DomHouseSolarAutoconsumptionCardEditor extends LitElement {
  ...
  _valueChanged(ev) {
    ...
    // Converte automaticamente in numero i campi delle dimensioni se valorizzati
    if (['font_size', 'icon_size', 'card_padding'].includes(configValue)) {
